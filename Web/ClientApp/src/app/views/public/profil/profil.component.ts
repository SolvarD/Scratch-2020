...
export class ProfilComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.slides = [{
      ...
      from:'01/04/2020',
      to: '--',
      context:`Ayant Quitté Extia après tant d'années de cocooning, j'ai décidé de créer GlobalDevApp pour créer des application à la demande et/ou faire du freelance (l'avenir montrera la voie)`,
